...
export const DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Built a TypeScript-based shift scheduling system with batch validation to replace manual entry for 500+ weekly shifts. Improved PostgreSQL role query performance in Ruby on Rails by applying caching, reducing response time from 1200ms to 70ms. Created full-stack metric dashboards with Vue.js and REST APIs to support faster, data-driven decisions.",
    },
